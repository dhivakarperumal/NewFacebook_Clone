...
<div className="full_details">
        <div className="left_side">
            <div className="lists">
                ...
                <div className="profile"><img src={require('../Components/images/3.jpg')} /><span className='span1'>Dhivakar P</span></div>
            ...
            <div className="box_content">
                <div className="centerhead">
                    ...
                    <div className="name12" >
                        <h3 className='names'>Sakthivel D<span><i className="fa fa-ellipsis-h" aria-hidden="true"></i><i className="fa fa-times" aria-hidden="true"></i></span></h3>
...
<br></br>
            ...
            <div className="box_content">
               <h4>Suggested for you</h4>
                ...
                <div className="centerhead">
                    <a href="" id="images1"><img src={require('../Components/images/6.jpg')} width="50px" height="50px" /></a>
                    <div className="name12" >
                        <h3 className='names'>Sonthosh <span><i className="fa fa-ellipsis-h" aria-hidden="true"></i><i className="fa fa-times" aria-hidden="true"></i></span></h3>
        ...
        <div className="right_side">
            ...
            <div className="lis">
                <div className="profile"><img src={require('../Components/images/6.jpg')} /><span>Dhivakar P</span></div>
                <div className="profile"><img src={require('../Components/images/2.jpg')} /><span>Arun</span></div>
                <div className="profile"><img src={require('../Components/images/3.jpg')} /><span>Karthick</span></div>
                <div className="profile"><img src={require('../Components/images/4.jpg')} /><span>Rajesh</span></div>
                <div className="profile"><img src={require('../Components/images/5.jpg')} /><span>Perumal</span></div>
                <div className="profile"><img src={require('../Components/images/6.jpg')} /><span>Divya S</span></div>
                <div className="profile"><img src={require('../Components/images/7.jpg')} /><span>Murali A</span></div>
                <div className="profile"><img src={require('../Components/images/8.jpeg')} /><span>Sathya</span></div>
                <div className="profile"><img src={require('../Components/images/1.jpg')}/><span>Kathir</span></div>
                <div className="profile"><img src={require('../Components/images/2.jpg')}/><span>Subash.S</span></div>
                <div className="profile"><img src={require('../Components/images/3.jpg')}/><span>Santhiya</span></div>
                <div className="profile"><img src={require('../Components/images/4.jpg')} /><span>Kowsiliya</span></div>
                <div className="profile"><img src={require('../Components/images/5.jpg')} /><span>Deivane</span></div>
                <div className="profile"><img src={require('../Components/images/6.jpg')} /><span>Sakthivel</span></div>
                <div className="profile"><img src={require('../Components/images/7.jpg')} /><span>Harish</span></div>
                <div className="profile"><img src={require('../Components/images/8.jpeg')} /><span>Kamali.K</span></div>
                <div className="profile"><img src={require('../Components/images/3.jpg')} /><span>Suvithra.S</span></div>
                <div className="profile"><img src={require('../Components/images/6.jpg')} /><span>Komath.s</span></div>
                <div className="profile"><img src={require('../Components/images/5.jpg')} /><span>Kavitha</span></div>
                <div className="profile"><img src={require('../Components/images/6.jpg')} /><span>Siva Kumar</span></div>
                <div className="profile"><img src={require('../Components/images/3.jpg')} /><span>Kamesh Kumar</span></div>
                <hr></hr>
            </div>
        </div>
